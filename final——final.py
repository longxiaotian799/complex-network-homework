...
plt.plot(degree_keys, rc_values, 'b.-', label='RC')
plt.plot(degree_keys, rc_random_values, 'r.-', label='Randomized RC')
...
# 在第一个子图中绘制第一张图形
ax[0].plot(degree_keys, rc_values, 'b.-', label='RC')
ax[0].legend(loc='best')
ax[0].set_xlabel('Degree')
ax[0].set_ylabel('Rich Club Coefficient')

# 在第二个子图中绘制第二张图形
ax[1].plot(degree_keys, rc_random_values, 'r.-', label='Randomized RC')
ax[1].legend(loc='best')
ax[1].set_xlabel('Degree')
ax[1].set_ylabel('Random Rich Club Coefficient')
